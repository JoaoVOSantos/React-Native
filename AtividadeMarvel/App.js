        ...
        <ScrollView>
            <View style={styles.container}>
                ...
                <View style={styles.button}>
                    <Button mode="contained" style={{ backgroundColor: 'green', margin: 5 }} onPress={() => conexao()}>
                        Buscar
                    </Button>
                ...
                {dados.map((personagem) => (
                    <Card key={personagem.id} style={{ width: "400px", margin: 10 }}>
                        <Card.Content>
                            <Text variant="titleLarge">{personagem.name}</Text>
                            <Text variant="bodyMedium">{personagem.description || "Personagem não possui descrição"}</Text>
                        </Card.Content>
